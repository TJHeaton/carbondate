...
data_frame FindPredictiveDensityAndCIWalker(doubles calendar_ages, list weights, list phis, list taus, doubles mu_phis, double lambda, double nu1, double nu2, int n_posterior_samples, double quantile_edge_width, int n_burn);
extern "C" SEXP _carbondate_FindPredictiveDensityAndCIWalker(SEXP calendar_ages, SEXP weights, SEXP phis, SEXP taus, SEXP mu_phis, SEXP lambda, SEXP nu1, SEXP nu2, SEXP n_posterior_samples, SEXP quantile_edge_width, SEXP n_burn) {
  BEGIN_CPP11
...
// find_predictive_density.cpp
data_frame FindPredictiveDensityandCIPolyaUrn(doubles calendar_ages, list observations_per_clusters, list phis, list taus, doubles alphas, doubles mu_phis, double n_obs, double lambda, double nu1, double nu2, int n_posterior_samples, double quantile_edge_width, int n_burn);
extern "C" SEXP _carbondate_FindPredictiveDensityandCIPolyaUrn(SEXP calendar_ages, SEXP observations_per_clusters, SEXP phis, SEXP taus, SEXP alphas, SEXP mu_phis, SEXP n_obs, SEXP lambda, SEXP nu1, SEXP nu2, SEXP n_posterior_samples, SEXP quantile_edge_width, SEXP n_burn) {
  BEGIN_CPP11
...
// find_predictive_density.cpp
doubles FindInstantPredictiveDensityPolyaUrn(doubles calendar_ages, integers observations_per_cluster, doubles phi, doubles tau, double alpha, double mu_phi, double lambda, double nu1, double nu2);
extern "C" SEXP _carbondate_FindInstantPredictiveDensityPolyaUrn(SEXP calendar_ages, SEXP observations_per_cluster, SEXP phi, SEXP tau, SEXP alpha, SEXP mu_phi, SEXP lambda, SEXP nu1, SEXP nu2) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_carbondate_FindInstantPredictiveDensityPolyaUrn", (DL_FUNC) &_carbondate_FindInstantPredictiveDensityPolyaUrn,  9},
    {"_carbondate_FindInstantPredictiveDensityWalker",   (DL_FUNC) &_carbondate_FindInstantPredictiveDensityWalker,    8},
    {"_carbondate_FindPredictiveDensityAndCIWalker",     (DL_FUNC) &_carbondate_FindPredictiveDensityAndCIWalker,     11},
    {"_carbondate_FindPredictiveDensityWalker",          (DL_FUNC) &_carbondate_FindPredictiveDensityWalker,           8},
    {"_carbondate_FindPredictiveDensityandCIPolyaUrn",   (DL_FUNC) &_carbondate_FindPredictiveDensityandCIPolyaUrn,   13},
