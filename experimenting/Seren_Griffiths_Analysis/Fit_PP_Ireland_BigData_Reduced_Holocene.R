...
recent_Republic_Ireland <- which(Republic_Ireland_c14_ages < radiocarbon_age_cutoff)
Holocene_Republic_Ireland_c14_ages <- Republic_Ireland_c14_ages[recent_Republic_Ireland]
Holocene_Republic_Ireland_c14_sigs <- Republic_Ireland_c14_sigs[recent_Republic_Ireland]


Holocene_Republic_Ireland_Output <- PPcalibrateLargeSets(
  rc_determinations = Holocene_Republic_Ireland_c14_ages,
  rc_sigmas = Holocene_Republic_Ireland_c14_sigs,
...
Holocene_Republic_Ireland_PostMeanRate <- PlotPosteriorMeanRate(
  Holocene_Republic_Ireland_Output,
