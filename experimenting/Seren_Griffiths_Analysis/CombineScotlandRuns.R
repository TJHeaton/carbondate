...
# Combine Scotland Output
load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_Scotland_Analysis_seed2.RData")
Scotland_run_seed_2 <- Holocene_Scotland_Output

load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_Scotland_Analysis_seed47.RData")
Scotland_run_seed_47 <- Holocene_Scotland_Output

load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_Scotland_Analysis_seed71.RData")
Scotland_run_seed_71 <- Holocene_Scotland_Output

output_data_list <- list(Scotland_run_seed_2,
                         Scotland_run_seed_47,
                         Scotland_run_seed_71)

Holocene_Scotland_Output <- CombineRuns(output_data_list)

pdf("../SerenGriffithsData/OutputPlots/PriorMean_10_Internal_Changes/Combined/Scotland_PP_Rate_Output_Holocene_Combined.pdf",
    width = 12,
    height = 8)
...
lines(x = 1950 - Holocene_Scotland_PostMeanRate$calendar_age_BP,
      y = Holocene_Scotland_PostMeanRate$rate_mean,
      col = "purple", type = "l")
lines(x = 1950 - Holocene_Scotland_PostMeanRate$calendar_age_BP,
      y = Holocene_Scotland_PostMeanRate$rate_ci_lower,
      col = "purple", type = "l", lty = 2)
lines(x = 1950 - Holocene_Scotland_PostMeanRate$calendar_age_BP,
      y = Holocene_Scotland_PostMeanRate$rate_ci_upper,
      col = "purple", type = "l", lty = 2)
...
write.csv(Holocene_Scotland_PostMeanRate, output_filename, row.names = FALSE)
