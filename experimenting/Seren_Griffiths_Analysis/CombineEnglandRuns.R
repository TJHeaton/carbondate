...
# Combine England Output
load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_England_Analysis_seed27_kmax_40.RData")
England_run_seed_27_kmax_40 <- Holocene_England_Output

load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_England_Analysis_seed59_kmax_40.RData")
England_run_seed_59_kmax_40 <- Holocene_England_Output

load("../SerenGriffithsData/RWorkspaces/PriorMean10Changes/Holocene_England_Analysis_seed95_kmax_40.RData")
England_run_seed_95_kmax_40 <- Holocene_England_Output

output_data_list <- list(England_run_seed_27_kmax_40,
                         England_run_seed_59_kmax_40,
                         England_run_seed_95_kmax_40)

Holocene_England_Output <- CombineRuns(output_data_list)

pdf("../SerenGriffithsData/OutputPlots/PriorMean_10_Internal_Changes/Combined/England_PP_Rate_Output_Holocene_Combined_kmax_40.pdf",
    width = 12,
    height = 8)
...
lines(x = 1950 - Holocene_England_PostMeanRate$calendar_age_BP,
     y = Holocene_England_PostMeanRate$rate_mean,
     col = "purple", type = "l")
lines(x = 1950 - Holocene_England_PostMeanRate$calendar_age_BP,
      y = Holocene_England_PostMeanRate$rate_ci_lower,
      col = "purple", type = "l", lty = 2)
lines(x = 1950 - Holocene_England_PostMeanRate$calendar_age_BP,
      y = Holocene_England_PostMeanRate$rate_ci_upper,
      col = "purple", type = "l", lty = 2)
...
write.csv(Holocene_England_PostMeanRate, output_filename, row.names = FALSE)
