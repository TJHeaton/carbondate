...
50 simulated marine radiocarbon determinations for which the underlying
...
Marine20 calibration curve with a \\\Delta R\\ of \\-50 \pm 30\\
\\{}^{14}\\C yr. The simulated values incorporate both the uncertainty
in the calibration curve and a hypothetical measurement uncertainty:
\$\$X_i \| \theta_i \sim N(m(\theta_i), \rho(\theta_i)^2 +
\sigma\_{i,\textrm{lab}}^2),\$\$ where \\m(\theta_i)\\ and
\\\rho(\theta_i)\\ are the Marine20 pointwise means and uncertainties;
and \\\sigma\_{i,\textrm{lab}}\\, the simulated laboratory measurement
uncertainty, was fixed at a common value of 25 \\{}^{14}\\C yrs. The
simulated \\\Delta R\\ of \\-50 \pm 30\\ \\{}^{14}\\C yrs is then
added.  
...
- delta_r:
  ...
  The \\\Delta R\\ offset, set at \\-50\\ \\{}^{14}\\C yrs

- delta_r_sig:

  The (1\\\sigma\\) uncertainty in the \\\Delta R\\ offset. Set at 30
  \\{}^{14}\\C yrs
