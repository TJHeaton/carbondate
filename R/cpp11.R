...
FindPredictiveDensityWalker <- function(calendar_ages, weight, phi, tau, mu_phi, lambda, nu1, nu2) {
  .Call(`_carbondate_FindPredictiveDensityWalker`, calendar_ages, weight, phi, tau, mu_phi, lambda, nu1, nu2)
}

FindPredictiveDensityPolyaUrn <- function(calendar_ages, cluster_ids, phi, tau, alpha, mu_phi, lambda, nu1, nu2) {
  .Call(`_carbondate_FindPredictiveDensityPolyaUrn`, calendar_ages, cluster_ids, phi, tau, alpha, mu_phi, lambda, nu1, nu2)
}
