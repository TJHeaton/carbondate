...
An R package to analyse, and summarise, multiple radiocarbon (^14^C) determinations. The package provides two linked (but distinct) approaches that can both be used to obtain rigorous and robust alternatives to summed probability distributions:

- Bayesian Non-Parametric Density Estimation (a rigorous and robust alternative to summed probability distributions)
...
The remaining datasets are from real-life data. The Northern Hemispehere IntCal calibration curves and Southern Hemisphere SHCal calibration curves are also provided.
