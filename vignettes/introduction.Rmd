...
cal_age_prob = CalibrateSingleDetermination(
  c14_determination = 1413, c14_uncertainty = 25, intcal20)
plot(
...
```{r find_spd}
spd = FindSPD(c(1000, 4500), armit$c14_ages, armit$c14_sig, intcal20)
plot(
  spd,
  type="l", 
  xlab = "Calendar age (yr BP)", 
...
You can calculate and plot this using `PlotIndividualCalendarAgeDensity` - for example to calculate the posterior calendar age distribution for the 10th ^14^C determination:
...
densities = PlotCalendarAgeDensity(
  c14_determinations = kerr$c14_ages,
  c14_uncertainties = kerr$c14_sig,
  calibration_curve = intcal20,
