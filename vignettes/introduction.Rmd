...
Note this example only runs for 100 iterations - this is to keep the run time short, but is not enough to lead to a converged results. We suggest running for 100,000 iterations to arrive at the converged results, which are shown in [@heaton2021].
...
PlotCalendarAgeDensityIndividualSample(10, walker_temp)
```
