...
You can calculate and plot this using `PlotCalendarAgeDensityInvidualSample` - for example to calculate the posterior calendar age distribution for the 10th ^14^C determination:
