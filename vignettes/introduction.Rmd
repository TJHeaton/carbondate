...
spd = FindSummedProbabilityDistribution(c(1000, 4500), armit$c14_age, armit$c14_sig, intcal20)
plot(
  spd,
  type="l", 
  xlab = "Calendar age (yr BP)", 
...
We also have the option to plot the SPD, and change the confidence intervals on the plot.
