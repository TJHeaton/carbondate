...
# Non-parametric calibration and summarisation of multiple related ^14^C samples
...
that allow you to annotate the summary plots showing the posterior mean rate and the changepoint locations. For example:
