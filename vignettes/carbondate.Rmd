...
- summarisation of the underlying calendar age distribution from which the samples arise $f(\theta)$ provides a potentially useful proxy for activity, population size, the frequency of past events. This approach uses the principle of _dates-as-data_ [@rick1987]
