...
```{r changepoint_number, out.width="100%", fig.width=10, fig.height=8}
...
```{r changepoint_locations, out.width="100%", fig.width=10, fig.height=8}
...
```{r changepoint_rates, out.width="100%", fig.width=10, fig.height=8}
